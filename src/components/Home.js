      ...
      >
        ...
        <div className="cube-container animated-flicker">
          <div className="box-card">
            <div className="face front"><img src='/skills/Java.png' alt="Java" style={{ height: '60px', margin: 'auto' }} /></div>
            <div className="face back"><img src= '/skills/Tailwind CSS.png' alt="Tailwind Css" style={{ height: '60px', margin: 'auto' }} /></div>
            <div className="face right"><img src= '/skills/JavaScript.png' alt="JavaScript" style={{ height: '60px', margin: 'auto' }} /></div>
            <div className="face left"><img src= '/skills/React.png' alt="React" style={{ height: '60px', margin: 'auto' }} /></div>
            <div className="face top"><img src= '/skills/HTML5.png' alt="HTML" style={{ height: '60px', margin: 'auto' }} /></div>
            <div className="face bottom"><img src= '/skills/CSS3.png' alt="CSS3" style={{ height: '60px', margin: 'auto' }} /></div>
          </div>
        </div>
